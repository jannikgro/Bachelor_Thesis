...
Für die gleich folgenden Verfahren ist insbesondere die Erkenntnis wichtig, dass Q-Learning-Verfahren zur systematischen Überschätzung der Aktionswerte führt. \cite{qlearningoverestimation}
...
Stattdessen wird PPO betrachtet, was 2018 erschien und ebenfalls den Unterschied zwischen alten und neuen Wahrscheinlichkeiten begrenzt. \cite{ppo2018}
...
Soft Actor Critic (SAC) ist ein verwendet wie TD3 ein neuronales Netz, das Werte schätzt, und eines, das die Parameter einer stochastischen Policy schätzt.
...
Das bedeutet, dass eine Policy $\pi$ gefunden werden soll, die möglichst zufällig ist und dennoch sehr gute Ergebnisse liefert.
