...
\begin{equation}
    L(\phi, \phi_{old}) = \mathbb{E}_{S_t, A_t}\left[\min{\left(\text{clip}{\left(1 + \varepsilon, 1 - \varepsilon, \hat{A}_t \cdot r(S_t, A_t, \phi, \phi_{old})\right)}, \hat{A}_t \cdot r(S_t, A_t, \phi, \phi_{old})\right)}\right]
\end{equation}
