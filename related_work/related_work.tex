...
Wenn es nach dem Sampling der Episoden direkt mittels überwachtem Lernens trainiert wird, so spricht man manchmal von >>REINFORCE mit Baseline<< oder >>Vanilla Policy Gradient Algorithm<<.
