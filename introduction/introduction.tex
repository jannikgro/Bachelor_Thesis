...
\begin{enumerate}
    ...
    \item die Anzahl der Elemente, die zirkulieren ($n_{zirk}$),
...
Kurz sollte noch einmal auf den Schrittzähler eingegangen werden.
In zahlreichen Formulierungen wird er nicht benötigt, hier ist er aber wegen der festen Episodenlänge ein Teil des Zustands.
...
Am Ende ist jedoch kein Raum mehr für langfristige Planung, und hohe Verkaufspreise führen zu schnelleren Gewinnen.
