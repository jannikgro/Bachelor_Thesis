...
Der heute am meisten verwendete Ansatz für das Dynamic Pricing ist die Festlegung von Regeln durch menschliche Experten.
Solche Funktionen für die Einpreisung der verkauften Waren erhalten genau wie die RL-Agenten die oben definierten Parameter, um daraus einen möglichst guten Preis zu bestimmen.
...
\begin{itemize}
    ...
    \item Der Rückkaufpreis sollte stets so niedrig sein wie auf dem Markt realisierbar.
\end{itemize}

Diese Überlegungen führen zur regelbasierten Strategie mit der folgenden Formel:
\begin{equation}
    \pi(p_{2, gebraucht}, n_{lager})_{gebraucht} =
    \begin{cases}
