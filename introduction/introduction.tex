...
\begin{enumerate}
    ...
    \item den Rückkaufpreis ($p_{1, rück}$), für den von einem Eigentümer gebrauchte Produkte zurückgekauft werden.
\end{enumerate}
...
\begin{equation}
    \sigma(p_{1, gebraucht}, p_{1, neu}, p_{2, gebraucht}, p_{2, neu}) = \left[
        1,
