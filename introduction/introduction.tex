...
Zudem müssen alle Produkte des meist sehr breiten Angebots auf diese Weise mit aktuellen Preisen in Abhängigkeit der Marktsituation versehen werden.
...
Reinforcement Learning (RL) ermöglicht, nur auf Grundlage eines Marktes durch Ausprobieren und Erfahrung sammeln eine Preisstrategie zu optimieren.
...
Für den Vergleich von Reinforcement-Learning-Algorithmen ist allerdings ein vergleichbares Setup das Entscheidende.
...
In zahlreichen Literaturbeispielen wird er nicht benötigt, hier ist er aber wegen der festen Episodenlänge ein Teil der Beobachtung.
Er wirkt sich nicht auf die Dynamik des Marktes aus, wohl aber auf den Umgang der Agenten mit ihm.
