...
\begin{figure}[htbp]
	...
	\caption{Lernkurven von A2C und PPO bei vollständiger im Vergleich zu partieller Beobachtung; (blau) vollständige Beobachtung, (orange) Lagerstand des Konkurrenten wird nicht bereitgestellt, (grün) Lagerstand des Konkurrenten und Anzahl der Produkte in Zirkulation werden nicht bereitgestellt}
	\label{grafic:PartialObservation}
\end{figure}

Die Lernkurven sind in Abbildung \ref{grafic:PartialObservation} dargestellt.
Das Ergebnis fällt dabei äußerst überraschend aus.
Entgegen der Erwartung, dass weniger Informationen zu schlechteren Ergebnissen führen müssten, steigt die Leistung der Agenten sogar.
Während der Agent, dem nur der Lagerstand des Konkurrenten vorenthalten wird, recht ähnliche Ergebnisse wie der mit vollständiger Information erzielt, ist die Performance bei den Versuchen, bei denen zusätzlich die Information über die Anzahl der Produkte in Zirkulation fehlt, etwa 30\% höher.

Zur Erklärung dieses Paradoxons ist zunächst heranzuführen, dass diese Informationen nur eine nachgeordnete Rolle spielen.
...
Dass die Experimente mit vollständiger Information 50\% mehr Dimensionen erhalten, ist nicht unerheblich.
