...
%    \boldNumberSetsfalse % Use this value if you want variables for number sets (like N or R) to appear in blackboard bold rather than bold.
    ...
    \myTitle{A comparison of current reinforcement learning algorithms for dynamic pricing in re-commerce}{Ein Vergleich aktueller Reinforcement Learning Algorithmen für dynamische Preisgestaltung im Re-commerce}
    ...
    \additionalExaminers{Johannes Huegle, Alexander Kastius}
